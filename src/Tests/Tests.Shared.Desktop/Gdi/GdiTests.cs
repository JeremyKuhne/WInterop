    ...
    public class GdiTests
    {
        ...
        public unsafe void EnumFont_Arial()
        {
            using (var context = GdiMethods.GetDeviceContext(WindowMethods.GetDesktopWindow()))
            {
                ...
                regular.FontAttributes.elfEnumLogfontEx.elfFullName.ToNullTerminatedString().Should().Be("Arial");
                regular.FontAttributes.elfEnumLogfontEx.elfStyle.ToNullTerminatedString().Should().Be("Regular");
                regular.FontAttributes.elfEnumLogfontEx.elfScript.ToNullTerminatedString().Should().Be("Western");
