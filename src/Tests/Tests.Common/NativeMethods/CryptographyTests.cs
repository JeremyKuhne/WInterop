...
namespace WInterop.Tests.NativeMethodTests
{
    public class CryptographyTests
    {
        ...
        public void BasicEnumerateStores()
        {
            ...
            var localMachine = NativeMethods.Cryptography.EnumerateSystemStores(SystemStoreLocation.CERT_SYSTEM_STORE_LOCAL_MACHINE);
            localMachine.Should().NotBeEmpty();

            var localMachineByName = NativeMethods.Cryptography.EnumerateSystemStores(SystemStoreLocation.CERT_SYSTEM_STORE_LOCAL_MACHINE, localMachineName);
        ...
        public void BasicEnumeratePhysical()
        {
            ...
            var physical = NativeMethods.Cryptography.EnumeratePhysicalStores(SystemStoreLocation.CERT_SYSTEM_STORE_LOCAL_MACHINE, "Root");
