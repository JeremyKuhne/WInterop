...
public static class KnownFolderIds
{
    ...
    /// </remarks>
    public static readonly Guid AccountPictures = new("{008ca0b1-55b4-4c56-b8a8-4de4b299d3be}");
    ...
    ///  Windows 8 and higher
    /// </remarks>
    public static readonly Guid ApplicationShortcuts = new("{A3918781-E5F2-4890-B3D9-A7E54332328C}");
    ...
    ///  Windows 8 and higher
    /// </remarks>
    public static readonly Guid CameraRoll = new("{AB5FB87B-7CE2-4F83-915D-550846C9537B}");
    ...
    /// </summary>
    public static readonly Guid DeviceMetadataStore = new("{5CE4A5E9-E4EB-479D-B89F-130C02886155}");
    ...
    /// </summary>
    public static readonly Guid DocumentsLibrary = new("{7B0DB17D-9CD2-4A93-9733-46CC89022E7C}");
    ...
    /// </summary>
    public static readonly Guid HomeGroup = new("{52528A6B-B9E3-4ADD-B60D-588C2DBA842D}");

    /// <summary>
    ///  Homegroup current user virtual folder
    /// </summary>
    public static readonly Guid HomeGroupCurrentUser = new("{9B74B6A3-0DFD-4f11-9E78-5F7800F2E772}");

    /// <summary>
    ///  ImplicitAppShortcuts folder "%APPDATA%\Microsoft\Internet Explorer\Quick Launch\User Pinned\ImplicitAppShortcuts"
    /// </summary>
    public static readonly Guid ImplicitAppShortcuts = new("{BCB5256F-79F6-4CEE-B725-DC34E402FD46}");
    ...
    /// </summary>
    public static readonly Guid Libraries = new("{1B3EA5DC-B587-4786-B4EF-BD1DC332AEAE}");
    ...
    /// </summary>
    public static readonly Guid MusicLibrary = new("{2112AB0A-C86A-4FFE-A368-0DE96E47012E}");
    ...
    /// </summary>
    public static readonly Guid PicturesLibrary = new("{A990AE9F-A03B-4E80-94BC-9912D7504104}");
    ...
    /// </summary>
    public static readonly Guid PublicLibraries = new("{48DAF80B-E6CF-4F4E-B800-0E69D84EE384}");
    ...
    /// </summary>
    public static readonly Guid PublicRingtones = new("{E555AB60-153B-4D17-9F04-A5FE99FC15EC}");

    /// <summary>
    ///  Public Account Pictures folder "%PUBLIC%\AccountPictures"
    /// </summary>
    public static readonly Guid PublicUserTiles = new("{0482af6c-08f1-4c34-8c90-e17ec98b1e17}");
    ...
    /// </summary>
    public static readonly Guid RecordedTVLibrary = new("{1A6FDBA2-F42D-4358-A798-B74D745926C5}");
    ...
    /// </summary>
    public static readonly Guid Ringtones = new("{C870044B-F49E-4126-A9C3-B52A1FF411E8}");
    ...
    ///  Windows 8 and higher
    /// </remarks>
    public static readonly Guid RoamedTileImages = new("{AAA8D5A5-F1D6-4259-BAA8-78E7EF60835E}");
    ...
    ///  Windows 8 and higher
    /// </remarks>
    public static readonly Guid RoamingTiles = new("{00BCFC5A-ED94-4e48-96A1-3F6217F21990}");
    ...
    /// </summary>
    public static readonly Guid SavedPictures = new("{3B193882-D3AD-4eab-965A-69829D1FB59F}");

    /// <summary>
    ///  Saved Pictures library folder "%APPDATA%\Microsoft\Windows\Libraries\SavedPictures.library-ms"
    /// </summary>
    public static readonly Guid SavedPicturesLibrary = new("{E25B5812-BE88-4bd9-94B0-29233477B6C3}");
    ...
    /// </summary>
    public static readonly Guid SearchHistory = new("{0D4C3DB6-03A3-462F-A0E6-08924C41B5D4}");
    ...
    /// </summary>
    public static readonly Guid SearchTemplates = new("{7E636BFE-DFA9-4D5E-B456-D7B39851D8A9}");
    ...
    /// </summary>
    public static readonly Guid SkyDrive = new("{A52BBA46-E9E1-435f-B3D9-28DAA648C0F6}");

    /// <summary>
    ///  OneDrive Camera Roll folder "%USERPROFILE%\OneDrive\Pictures\Camera Roll"
    /// </summary>
    public static readonly Guid SkyDriveCameraRoll = new("{767E6811-49CB-4273-87C2-20F355E1085B}");

    /// <summary>
    ///  OneDrive Documents folder "%USERPROFILE%\OneDrive\Documents"
    /// </summary>
    public static readonly Guid SkyDriveDocuments = new("{24D89E24-2F19-4534-9DDE-6A6671FBB8FE}");

    /// <summary>
    ///  OneDrive Pictures folder "%USERPROFILE%\OneDrive\Pictures"
    /// </summary>
    public static readonly Guid SkyDrivePictures = new("{339719B5-8C47-4894-94C2-D8F77ADD44A6}");
    ...
    /// </summary>
    public static readonly Guid UserPinned = new("{9E3995AB-1F9C-4F13-B827-48B24B6C7174}");
    ...
    /// </summary>
    public static readonly Guid UserProgramFilesCommon = new("{BCBD3057-CA5C-4622-B42D-BC56DB0AE516}");
    ...
    /// </summary>
    public static readonly Guid UsersLibraries = new("{A302545D-DEFF-464b-ABE8-61C8648D939B}");
    ...
    /// </summary>
    public static readonly Guid VideosLibrary = new("{491E922F-5643-4AF4-A7EB-4E7A138D8174}");
