...
public unsafe struct StorageStats : IDisposable
{
    ...
    public readonly ReadOnlySpan<char> Name => Strings.GetSpanFromNullTerminatedBuffer((char*)_stats.pwcsName);
    public readonly StorageType StorageType => (StorageType)_stats.type;
    public readonly ulong Size => _stats.cbSize.QuadPart;
