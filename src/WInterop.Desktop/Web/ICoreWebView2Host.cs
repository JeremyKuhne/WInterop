...
namespace WInterop.Web
{
    ...
    {
        IntBoolean IsVisible { get; set; }

        Rect Bounds { get; set; }

        double ZoomFactor { get; set; }

        void Stub_add_ZoomFactorChanged();
        ...
        void Stub_remove_ZoomFactorChanged();
        ...
        void Stub_remove_AcceleratorKeyPressed_Stub();
