...
{
    /// <summary>
    ///  Codes for controlling the mount point manager. (\\.\MountPointManager or \Device\MountPointManager)
    /// </summary>
    public enum MountManager : uint
    {
        ...
        /// <summary>
        ///  Create a mount point. Uses MOUNTMGR_CREATE_POINT_INPUT. [IOCTL_MOUNTMGR_CREATE_POINT]
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///  Gets the existing drive letter or assigns the next available letter if applicable. Uses
        ///  MOUNTMGR_DRIVE_LETTER_TARGET for input and MOUNTMGR_DRIVE_LETTER_INFORMATION for output.
