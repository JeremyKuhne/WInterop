...
namespace WInterop.Storage
{
    ...
    public enum CreateOptions : uint
    {
        ...
        /// </summary>
        /// <remarks>
        ///  Can only be used with <see cref="SynchronousIoAlert"/>, <see cref="SynchronousIoNonalert"/>,
        ///  <see cref="WriteThrough"/>, <see cref="OpenForBackupIntent"/>, and <see cref="OpenByFileId"/> flags.
        /// </remarks>
