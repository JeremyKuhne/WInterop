...
namespace WInterop.FileManagement
{
    public static partial class NativeMethods
    {
            ...
            SecurityQosFlags securityQosFlags = SecurityQosFlags.NONE)
        {
            ...
            {
                return Desktop.NativeMethods.CreateFile(path, desiredAccess, shareMode, creationDisposition, fileAttributes, fileFlags, securityQosFlags);
            }
#endif
        }
        ...
        public static void CopyFile(string source, string destination)
        {
            ...
            {
                Desktop.NativeMethods.CopyFileEx(source, destination);
            }
#endif
        }
