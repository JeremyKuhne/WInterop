...
namespace WInterop.Authorization.DataTypes
{
    ...
    {
        // DELETE through SPECIFIC_RIGHTS_ALL are masks for the predefined standard access types
        ...
        // Generic rights are mapped for each type of object to a specific set of rights
